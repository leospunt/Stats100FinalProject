#mixed_model_full_random_slopes <- lmer(score ~ WindSpeed + DayTemp + Humidity + Pressure + PriorTemp + DayStatus + PriorStatus + 
                                         #(WindSpeed + DayTemp + Humidity + Pressure + PriorTemp + DayStatus + PriorStatus|course) + 
                                        # (WindSpeed + DayTemp + Humidity + Pressure + PriorTemp + DayStatus + PriorStatus|round), 
                                     #  data = golf_weather_data)
...
plot(filtered_data$score, predicted_scores, 
     ...
     main = "Mixed Effects Model: Course and Round Random Effect",
